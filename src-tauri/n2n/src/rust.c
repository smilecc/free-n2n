...
static void setPayloadCompression(n2n_edge_conf_t *conf, int compression) {
    ...
    switch (compression) {
        ...
        default: {
            ...
            traceEvent(TRACE_NORMAL, "the %s compression given by -z_ option is not supported in this version",
                       compression_str(compression + 1));
...
static void setPayloadEncryption(n2n_edge_conf_t *conf, int cipher) {
    ...
    switch (cipher) {
        ...
        default: {
            ...
            traceEvent(TRACE_NORMAL, "the %s cipher given by -A_ option is not supported in this version",
                       transop_str(cipher));
            exit(1);
        }
    }
    ...
    switch (optkey) {
        ...
        case 'A': {
            ...
            if (optargument) {
                ...
                traceEvent(TRACE_WARNING,
                           "the use of the solitary -A switch is deprecated and will not be supported in future versions, "
        ...
        case 'z': {
            ...
            if (optargument) {
                ...
                traceEvent(TRACE_WARNING,
                           "the use of the solitary -z switch is deprecated and will not be supported in future versions, "
        ...
        case 'S': {
            ...
            if (optargument) {
                ...
                traceEvent(TRACE_WARNING,
                           "the use of the solitary -S switch is deprecated and will not be supported in future versions, "
...
#ifndef WIN32
    traceEvent(TRACE_NORMAL, "WIN32 flag is %d", WIN32);
...
int edge_set_config(char key, char *value) {
    return setOption(key, value, &ec, &conf);
}
